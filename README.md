<h1 align="center"> Hi! I am Anne</h1>
...
- 💙 Computer Science student (CEUB)
- 📍 Brasília, Brazil
- 🎨 Passionate about minimal design, well-crafted interfaces, and intuitive user experiences (UI/UX)
- ✨ I value clean, organized, and purposeful code
- 💻 Exploring software development, from back-end to front-end
- 🧠 I enjoy turning ideas into functional systems and interfaces
- 🛠️ Experience with Python, Java, SQL, and prototyping with Figma
...
Python-based game focused on logic, game rules, and back-end structure  
**Technologies:** Python, Tkinter  

- **[Web Cinemonroll](https://github.com/anne-cgm/web-cinemonroll)**  
Web application with database integration and back-end evolution  
...
![JDeploy](https://img.shields.io/badge/-JDeploy-FF6B00?style=for-the-badge&logo=java&logoColor=white)
...
</p> <p align="right"> <em>“Keep it soft, clean and kind.”</em> </p> 
